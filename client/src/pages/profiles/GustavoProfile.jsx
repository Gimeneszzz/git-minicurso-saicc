...
export default function GustavoProfile() {
            ...
            <div className="container mx-auto px-4">
              <div className="relative h-20 rounded-b flex justify-center">
                <div className="absolute -bottom-6">
                  {/* Sua foto aqui: */}
                    <img
                      src="https://pbs.twimg.com/profile_images/1689001384560009216/ZcQ-_Fd9_400x400.jpg"
              ...
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">                           
                    ...
                    Coe! gostoso,pai de dog, dev e jogador de rocketleague, tmj s2
                    </p>
                    <br/>
                    {/* Link para seu GitHub aqui: */}
                    <a 
                      href="https://github.com/Gimeneszzz" 
